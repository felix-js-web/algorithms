...
import static sprint4.BubbleSort.sortArrayBubbleSortT;
import static sprint4.InsertionSort.sortArrayInsertionSortI;

class BubbleSortTest {

    @Test
    void sortArrayBubbleSortTest() {
        ...
        for (int test = 0; test < 1000; test++) {
            ...
            // Сортируем массивы
            sortedBySelectionSort = sortArrayBubbleSortT(sortedBySelectionSort);
